...
const ViewDetailsModal = ({ visible, onCancel, deployment, t }) => {
  ...
  const getStatusConfig = (status) => {
    const statusConfig = {
      running: { color: 'green', text: '', icon: '🟢' },
      completed: { color: 'green', text: '', icon: '✅' },
      'deployment requested': { color: 'blue', text: '', icon: '🔄' },
      'termination requested': {
        color: 'orange',
        text: '',
        icon: '⏸️',
      },
      destroyed: { color: 'red', text: '', icon: '🔴' },
      failed: { color: 'red', text: '', icon: '❌' },
    };
            ...
            <div className='space-y-4'>
                  ...
                  },
                  {
                    ...
                    value: (
                      <div className='space-y-1'>
                        <div>
                          {t('GPU')}: {details.gpus_per_container}
                        </div>
                        <div>
                          {t('')}: {details.total_containers}
                        </div>
                      </div>
                    ),
                  },
              ...
              <div className='space-y-2'>
                ...
                <div className='flex justify-between text-xs text-gray-500'>
                  <span>
                    {t('')}: {details.compute_minutes_served} {t('')}
                  </span>
                  <span>
                    {t('')}: {details.compute_minutes_remaining} {t('')}
                  </span>
                </div>
              </div>
            </div>
