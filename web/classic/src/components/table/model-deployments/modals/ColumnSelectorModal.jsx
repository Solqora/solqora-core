...
const ColumnSelectorModal = ({
  ...
  const columnOptions = useMemo(
    () => [
      { key: columnKeys.container_name, label: t(''), required: true },
      { key: columnKeys.status, label: t('') },
      { key: columnKeys.time_remaining, label: t('') },
      { key: columnKeys.hardware_info, label: t('') },
      { key: columnKeys.created_at, label: t('') },
      { key: columnKeys.actions, label: t(''), required: true },
    ],
    [columnKeys, t],
  );
