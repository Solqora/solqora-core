          ...
          <Card className='mb-4'>
            ...
            <div className='mt-2'>
              ...
              <div style={{ marginTop: 8 }}>
                ...
                >
                  <Radio value='builtin'>{t(' Ollama ')}</Radio>
                  <Radio value='custom'>{t('')}</Radio>
                </RadioGroup>
              </div>
            </div>
