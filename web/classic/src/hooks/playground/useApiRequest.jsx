          ...
          if (type === 'reasoning') {
            ...
            if (
              ...
              if (
                ...
                thinkingCompleteFromTags = true; // think
              }
            }

            // contentreasoningthink
    ...
    (payload) => {
      ...
      source.addEventListener('message', (e) => {
        if (e.data === '[DONE]') {
          ...
          setDebugData((prev) => ({
            ...
            sseMessages: [...(prev.sseMessages || []), '[DONE]'], //  DONE 
            isStreaming: false,
          }));
          completeMessage();
          return;
      ...
      source.addEventListener('readystatechange', (e) => {
        ...
        if (
          ...
          const errorInfo = handleApiError(new Error('HTTP'));
