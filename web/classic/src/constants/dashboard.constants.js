...
export const ANNOUNCEMENT_LEGEND_DATA = [
  { color: 'grey', label: '', type: 'default' },
  { color: 'blue', label: '', type: 'ongoing' },
  { color: 'green', label: '', type: 'success' },
  { color: 'orange', label: '', type: 'warning' },
  { color: 'red', label: '', type: 'error' },
];

// ========== Uptime  ==========
export const UPTIME_STATUS_MAP = {
  1: { color: '#10b981', label: '', text: '' }, // UP
  0: { color: '#ef4444', label: '', text: '' }, // DOWN
  2: { color: '#f59e0b', label: '', text: '' }, // PENDING
  3: { color: '#3b82f6', label: '', text: '' }, // MAINTENANCE
};
