...
export function getRequestRuleMatchOptions(source, t) {
  if (source === SOURCE_TIME) {
    return [
      { value: MATCH_EQ, label: t('') },
      { value: MATCH_GTE, label: t('') },
      { value: MATCH_LT, label: t('') },
      { value: MATCH_RANGE, label: t('') },
    ];
  }
  const base = [
    { value: MATCH_EQ, label: t('') },
    { value: MATCH_CONTAINS, label: t('') },
    { value: MATCH_EXISTS, label: t('') },
  ];
  ...
  return [
    ...base,
    { value: MATCH_GT, label: t('') },
    { value: MATCH_GTE, label: t('') },
    { value: MATCH_LT, label: t('') },
    { value: MATCH_LTE, label: t('') },
  ];
}
