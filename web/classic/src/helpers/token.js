 ...
 * @returns {Promise<string>}  sk-  token key
 */
 ...
 * @returns {Promise<Record<number, string>>}  {id: key} mapkey  sk- 
 */
...
/**
 *  token keys
 * @returns {Promise<string[]>}  active  sk-  token key 
 */
...
export const CHANNEL_CONN_CLIPBOARD_TYPE = 'solqora_channel_conn';

/**
 * @param {string} key -  API key sk- 
 * @param {string} url - 
 * @returns {string} JSON 
 */
