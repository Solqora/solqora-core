 ...
 * 
 * - "OpenAI""OpenAI.Color" 
 * - "OpenAI.Avatar.type={'platform'}""OpenRouter.Avatar.shape={'square'}"
 * -  size size=
...
export function getLobeHubIcon(iconName, size = 14) {
  ...
  // key={...}key='...'key="..."key=123keykey=true/false
  const props = {};
...
export const modelColorMap = {
  ...
  // 'dall-e-2': 'rgb(147,112,219)', // 
  'dall-e-3': 'rgb(153,50,204)', // 
  'gpt-3.5-turbo': 'rgb(184,227,167)', // 
  // 'gpt-3.5-turbo-0301': 'rgb(131,220,131)', // 
  ...
  // 'text-davinci-002': 'rgb(199,21,133)', // 
  'text-davinci-003': 'rgb(219,112,147)', // Curie
  ...
  'text-moderation-stable': 'rgb(255,160,122)', // Babbage
  'tts-1': 'rgb(255,140,0)', // 
...
function renderBillingArticle(lines, { showReferenceNote = true } = {}) {
  ...
  if (showReferenceNote) {
    articleLines.push(buildBillingText(''));
  }
...
function renderPriceSimpleCore({
  ...
  if (outputMode === 'segments') {
    ...
    if (modelPrice !== -1) {
      ...
      segments.push({
        tone: 'secondary',
        text: i18next.t(' {{price}} / 1M tokens', {
      ...
      if (hasSplitCacheCreation && shouldShowCacheCreation5m) {
        segments.push({
          tone: 'secondary',
          text: i18next.t('5m {{price}} / 1M tokens', {
      ...
      if (hasSplitCacheCreation && shouldShowCacheCreation1h) {
        segments.push({
          tone: 'secondary',
          text: i18next.t('1h {{price}} / 1M tokens', {
            price: formatCompactDisplayPrice(
      ...
      if (hasSplitCacheCreation) {
        if (shouldShowCacheCreation5m && shouldShowCacheCreation1h) {
          ...
          segments.push({
            tone: 'secondary',
            text: i18next.t(': 5m {{cacheCreationRatio5m}}', {
              cacheCreationRatio5m: cacheCreationRatio5m,
            }),
          });
          ...
          segments.push({
            tone: 'secondary',
            text: i18next.t(': 1h {{cacheCreationRatio1h}}', {
              cacheCreationRatio1h: cacheCreationRatio1h,
            }),
          });
        }
        ...
        segments.push({
          tone: 'secondary',
          text: i18next.t(': {{cacheCreationRatio}}', {
  ...
  if (modelPrice !== -1) {
    ...
    return i18next.t('{{symbol}}{{price}} * {{ratioType}}{{ratio}}', {
      symbol: symbol,
      price: displayPrice,
  ...
  const parts = [];
  // base: model ratio
  parts.push(i18next.t(': {{ratio}}'));

  // cache part (label differs when with image)
  if (shouldShowCache) {
    parts.push(i18next.t(': {{cacheRatio}}'));
  }
  ...
  if (hasSplitCacheCreation) {
    if (shouldShowCacheCreation5m && shouldShowCacheCreation1h) {
      ...
      parts.push(i18next.t(': 5m {{cacheCreationRatio5m}}'));
    } else if (shouldShowCacheCreation1h) {
      parts.push(i18next.t(': 1h {{cacheCreationRatio1h}}'));
    }
  } else if (shouldShowLegacyCacheCreation) {
    parts.push(i18next.t(': {{cacheCreationRatio}}'));
  }

  // image part
  if (image) {
    parts.push(i18next.t(': {{imageRatio}}'));
  }
...
export function renderModelPrice(opts) {
  ...
  if (!shouldUseRatioBillingProcess(modelPrice)) {
    if (modelPrice !== -1) {
      return renderBillingArticle([
        buildBillingPriceText('{{symbol}}{{price}}', {
          symbol,
          usdAmount: modelPrice,
          rate,
        }),
        buildBillingPriceText(
            ' {{symbol}}{{price}} * {{ratioType}} {{ratio}} = {{symbol}}{{total}}',
            {
              symbol,
              usdAmount: modelPrice,
              rate,
    ...
    if (image && imageOutputTokens > 0) {
      inputDesc = buildBillingPriceText(
          '( {{nonImageInput}} tokens +  {{imageInput}} tokens / 1M tokens * {{symbol}}{{price}}',
          {
      ...
      inputDesc = buildBillingText(
          '( {{nonCacheInput}} tokens / 1M tokens * {{symbol}}{{price}} +  {{cacheInput}} tokens / 1M tokens * {{symbol}}{{cachePrice}}',
          {
      ...
      inputDesc = buildBillingText(
          '( {{nonAudioInput}} tokens / 1M tokens * {{symbol}}{{price}} +  {{audioInput}} tokens / 1M tokens * {{symbol}}{{audioPrice}}',
          {
      ...
      inputDesc = buildBillingPriceText(
          '( {{input}} tokens / 1M tokens * {{symbol}}{{price}}',
          {
            input: inputTokens,
            symbol,
            usdAmount: inputRatioPrice,
    ...
    const outputDesc = buildBillingText(
        ' {{completion}} tokens / 1M tokens * {{symbol}}{{compPrice}}) * {{ratioType}} {{ratio}}',
        {
    ...
    const extraServices = [
      webSearch && webSearchCallCount > 0
          ? buildBillingPriceText(
              ' + Web {{count}} / 1K  * {{symbol}}{{price}} * {{ratioType}} {{ratio}}',
              {
      ...
      fileSearch && fileSearchCallCount > 0
          ? buildBillingPriceText(
              ' +  {{count}} / 1K  * {{symbol}}{{price}} * {{ratioType}} {{ratio}}',
              {
      ...
      imageGenerationCall && imageGenerationCallPrice > 0
          ? buildBillingPriceText(
              ' +  {{symbol}}{{price}} / 1 * {{ratioType}} {{ratio}}',
              {
                symbol,
    ...
    const billingLines = [
      buildBillingPriceText(
          '{{symbol}}{{price}} / 1M tokens{{audioPrice}}',
          {
            symbol,
            usdAmount: inputRatioPrice,
            rate,
            audioPrice: audioInputSeperatePrice
                ? `${i18next.t('')} ${symbol}${formatBillingDisplayPrice(audioInputPrice, rate)} / 1M tokens`
                : '',
          },
      ),
      buildBillingPriceText('{{symbol}}{{total}} / 1M tokens', {
        symbol,
      ...
      image && imageOutputTokens > 0
          ...
          : null,
      webSearch && webSearchCallCount > 0
          ? buildBillingPriceText('Web{{symbol}}{{price}} / 1K ', {
            symbol,
            usdAmount: webSearchPrice,
            rate,
          })
          : null,
      fileSearch && fileSearchCallCount > 0
          ? buildBillingPriceText('{{symbol}}{{price}} / 1K ', {
            symbol,
            usdAmount: fileSearchPrice,
            rate,
          })
          : null,
      imageGenerationCall && imageGenerationCallPrice > 0
          ? buildBillingPriceText('{{symbol}}{{price}} / 1', {
            symbol,
            usdAmount: imageGenerationCallPrice,
            rate,
          })
  ...
  return renderBillingArticle([
    [
      buildBillingText(' {{modelRatio}}', {
        modelRatio: modelRatioValue,
      }),
      buildBillingText(' {{completionRatio}}', {
        completionRatio: completionRatioValue,
      }),
      cacheInputTokens > 0
          ? buildBillingText(' {{cacheRatio}}', {
            cacheRatio: cacheRatioValue,
          })
          : null,
      imageInputTokens > 0
          ? buildBillingText(' {{imageRatio}}', {
            imageRatio: imageRatioValue,
          })
          : null,
      audioRatioValue !== null
          ? buildBillingText(' {{audioRatio}}', {
    ...
    textInputTokens > 0
        ? buildBillingText(
            '{{tokens}} / 1M *  {{modelRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
    ...
    cacheInputTokens > 0
        ? buildBillingText(
            '{{tokens}} / 1M *  {{modelRatio}} *  {{cacheRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
    ...
    imageInputTokens > 0
        ? buildBillingText(
            '{{tokens}} / 1M *  {{modelRatio}} *  {{imageRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
    ...
    audioInputTokens > 0 && audioRatioValue !== null
        ? buildBillingText(
            '{{tokens}} / 1M *  {{modelRatio}} *  {{audioRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
        ...
        : null,
    buildBillingText(
        '{{tokens}} / 1M *  {{modelRatio}} *  {{completionRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
        {
    ...
    webSearch && webSearchCallCount > 0
        ? buildBillingText(
            'Web {{count}} / 1K *  {{price}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
              count: webSearchCallCount,
    ...
    fileSearch && fileSearchCallCount > 0
        ? buildBillingText(
            '{{count}} / 1K *  {{price}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
              count: fileSearchCallCount,
    ...
    imageGenerationCall && imageGenerationCallPrice > 0
        ? buildBillingText(
            '1  *  {{price}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
...
export function renderLogContent(opts) {
  ...
  if (isPriceDisplayMode(displayMode, modelPrice)) {
    ...
    const parts = [
      i18next.t(' {{symbol}}{{price}} / 1M tokens', {
        symbol,
  ...
  if (modelPrice !== -1) {
    ...
    if (image) {
      return i18next.t(
          ' {{modelRatio}} {{cacheRatio}} {{completionRatio}} {{imageRatio}}{{ratioType}} {{ratio}}',
          {
      ...
      return i18next.t(
          ' {{modelRatio}} {{cacheRatio}} {{completionRatio}}{{ratioType}} {{ratio}}Web  {{webSearchCallCount}} ',
          {
            modelRatio: modelRatio,
            cacheRatio: cacheRatio,
            completionRatio: completionRatio,
      ...
      return i18next.t(
          ' {{modelRatio}} {{cacheRatio}} {{completionRatio}}{{ratioType}} {{ratio}}',
          {
            modelRatio: modelRatio,
            cacheRatio: cacheRatio,
            completionRatio: completionRatio,
...
export function renderTieredModelPrice(opts) {
  ...
  const lines = [
    buildBillingText('{{tier}}', { tier: matchedTier || tier.label }),
    ...priceLines
...
export function renderAudioModelPrice(opts) {
  ...
  if (!shouldUseRatioBillingProcess(modelPrice)) {
    ...
    return renderBillingArticle([
      buildBillingPriceText('{{symbol}}{{price}} / 1M tokens', {
        symbol,
        usdAmount: inputRatioPrice,
        rate,
      }),
      ...
      buildBillingText(
          ' {{input}} tokens / 1M tokens * {{symbol}}{{textInputPrice}} +  {{completion}} tokens / 1M tokens * {{symbol}}{{textCompPrice}} +  {{audioInput}} tokens / 1M tokens * {{symbol}}{{audioInputPrice}} +  {{audioCompletion}} tokens / 1M tokens * {{symbol}}{{audioCompPrice}} * {{ratioType}} {{ratio}} = {{symbol}}{{total}}',
          {
            input: inputTokens,
            completion: completionTokens,
            audioInput: audioInputTokens,
  ...
  return renderBillingArticle([
    buildBillingText(
        ' {{modelRatio}} {{completionRatio}} {{audioRatio}} {{audioCompletionRatio}}{{cachePart}}{{ratioType}} {{ratio}}',
        {
          modelRatio: modelRatioValue,
          completionRatio: completionRatioValue,
          audioRatio: audioRatioValue,
    ...
    buildBillingText(
        '{{tokens}} / 1M *  {{modelRatio}} *  {{audioRatio}} *  {{audioCompletionRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
        {
...
export function renderQuotaWithPrompt(quota, digits) {
  const quotaDisplayType = localStorage.getItem('quota_display_type') || 'USD';
  if (quotaDisplayType !== 'TOKENS') {
    return i18next.t('') + renderQuota(quota, digits);
  }
  return '';
}
...
export function renderClaudeModelPrice(opts) {
  ...
  if (!shouldUseRatioBillingProcess(modelPrice)) {
    ...
    const breakdownSegments = [
      i18next.t(' {{input}} tokens / 1M tokens * {{symbol}}{{price}}', {
        input: inputTokens,
        symbol,
    ...
    if (shouldShowCache) {
      breakdownSegments.push(
          i18next.t(' {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}', {
            tokens: cacheTokens,
            symbol,
    ...
    if (shouldShowLegacyCacheCreation) {
      breakdownSegments.push(
          i18next.t(
              ' {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}',
              {
    ...
    if (shouldShowCacheCreation5m) {
      breakdownSegments.push(
          i18next.t(
              '5m {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}',
              {
    ...
    if (shouldShowCacheCreation1h) {
      breakdownSegments.push(
          i18next.t(
              '1h {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}',
              {
    ...
    breakdownSegments.push(
        i18next.t(
            ' {{completion}} tokens / 1M tokens * {{symbol}}{{price}}',
            {
              completion: completionTokens,
              symbol,
  ...
  return renderBillingArticle([
    buildBillingText(
        ' {{modelRatio}} {{completionRatio}} {{cacheRatio}}{{ratioType}} {{ratio}}',
        {
          modelRatio: modelRatioValue,
          completionRatio: completionRatioValue,
          cacheRatio: cacheRatioValue,
    ...
    hasSplitCacheCreation
        ...
        : buildBillingText(' {{cacheCreationRatio}}', {
    ...
    shouldShowLegacyCacheCreation
        ? buildBillingText(
            '{{tokens}} / 1M *  {{modelRatio}} *  {{cacheCreationRatio}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
              tokens: cacheCreationTokens,
              modelRatio: modelRatioValue,
              cacheCreationRatio: cacheCreationRatioValue,
    ...
    shouldShowCacheCreation5m
        ? buildBillingText(
            '5m{{tokens}} / 1M *  {{modelRatio}} * 5m {{cacheCreationRatio5m}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
              tokens: cacheCreationTokens5m,
              modelRatio: modelRatioValue,
              cacheCreationRatio5m: cacheCreationRatio5mValue,
    ...
    shouldShowCacheCreation1h
        ? buildBillingText(
            '1h{{tokens}} / 1M *  {{modelRatio}} * 1h {{cacheCreationRatio1h}} * {{ratioType}} {{ratio}} = {{amount}}',
            {
              tokens: cacheCreationTokens1h,
              modelRatio: modelRatioValue,
              cacheCreationRatio1h: cacheCreationRatio1hValue,
...
export function renderClaudeLogContent(opts) {
  ...
  if (modelPrice !== -1) {
    ...
    if (!cacheCreationPart) {
      cacheCreationPart = i18next.t(' {{cacheCreationRatio}}', {
        cacheCreationRatio,
      });
    }

    const parts = [
      i18next.t(' {{modelRatio}}', { modelRatio }),
      i18next.t(' {{completionRatio}}', { completionRatio }),
      i18next.t(' {{cacheRatio}}', { cacheRatio }),
      cacheCreationPart,
...
//  renderModelPriceSimple provider='claude'
