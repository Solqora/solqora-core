...
func SendEmailVerification(c *gin.Context) {
	...
	subject := fmt.Sprintf("%s", common.SystemName)
	content := fmt.Sprintf("<p>%s</p>"+
		"<p>: <strong>%s</strong></p>"+
		"<p> %d </p>", common.SystemName, code, common.VerificationValidMinutes)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if model.IsEmailAlreadyTaken(email) {
		...
		content := fmt.Sprintf("<p>%s</p>"+
			"<p> <a href='%s'></a> </p>"+
			"<p><br> %s </p>"+
			"<p> %d </p>", common.SystemName, link, link, common.VerificationValidMinutes)
		err := common.SendEmail(subject, email, content)
		if err != nil {
