...
// @Description 
// @Description 
// @Description - AI (Kling): https://app.klingai.com/cn/dev/document-api/apiReference/commonInfo
// @Description -  (Jimeng): https://www.volcengine.com/docs/85621/1538636
// @Tags Video
// @Accept json
// @Produce json
// @Param Authorization header string true " (Aeess-Token: sk-xxxx)"
// @Param request body dto.VideoRequest true ""
// @Failure 400 {object} dto.OpenAIError ""
// @Failure 401 {object} dto.OpenAIError ""
// @Failure 403 {object} dto.OpenAIError ""
// @Failure 500 {object} dto.OpenAIError ""
...
// @Success 200 {object} dto.VideoTaskResponse ""
// @Failure 400 {object} dto.OpenAIError ""
// @Failure 401 {object} dto.OpenAIError ""
// @Failure 403 {object} dto.OpenAIError ""
// @Failure 500 {object} dto.OpenAIError ""
...
// @Produce json
// @Param Authorization header string true " (Aeess-Token: sk-xxxx)"
// @Param request body KlingText2VideoRequest true ""
// @Success 200 {object} dto.VideoTaskResponse ""
// @Failure 400 {object} dto.OpenAIError ""
// @Failure 401 {object} dto.OpenAIError ""
// @Failure 403 {object} dto.OpenAIError ""
...
// @Produce json
// @Param Authorization header string true " (Aeess-Token: sk-xxxx)"
// @Param request body KlingImage2VideoRequest true ""
// @Success 200 {object} dto.VideoTaskResponse ""
// @Failure 400 {object} dto.OpenAIError ""
// @Failure 401 {object} dto.OpenAIError ""
// @Failure 403 {object} dto.OpenAIError ""
