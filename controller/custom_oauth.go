...
func FetchCustomOAuthDiscovery(c *gin.Context) {
	...
	if wellKnownURL == "" && issuerURL == "" {
		common.ApiErrorMsg(c, " Discovery URL  Issuer URL")
		return
	}
	...
	if err != nil || parsedURL.Host == "" || (parsedURL.Scheme != "http" && parsedURL.Scheme != "https") {
		common.ApiErrorMsg(c, "Discovery URL  http/https")
		return
	}
	...
	if err != nil {
		common.ApiErrorMsg(c, " Discovery : "+err.Error())
		return
	}
	...
	if resp.StatusCode != http.StatusOK {
		...
		common.ApiErrorMsg(c, " Discovery : "+message)
		return
	}
