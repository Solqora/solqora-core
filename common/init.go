...
func printHelp() {
	fmt.Println("Solqora Core " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Solqora Core — AI API gateway
	fmt.Println("Maintainer: solqora - https://github.com/solqora/solqora-core")
	fmt.Println("Usage: solqora [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
...
func InitEnv() {
	...
	if os.Getenv("SESSION_SECRET") != "" {
		...
		if ss == "random_string" {
			...
			log.Println("SESSION_SECRET'random_string'")
