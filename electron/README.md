# Solqora Electron Desktop App

This directory contains the Electron wrapper for Solqora, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., solqora-core-macos)
cp ../solqora-core-macos ../solqora-core
```
...
- Store database in `../data/solqora-core.db`
...
### Database Location
- **Development**: `../data/solqora-core.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Solqora/data/`
  - Windows: `%APPDATA%/Solqora/data/`
  - Linux: `~/.config/Solqora/data/`
