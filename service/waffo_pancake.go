...
// are exposed separately for self-service flows driven from solqora-core's own UI.
...
func WaffoPancakeBuyerIdentityFromUserID(userID int) string {
	return fmt.Sprintf("solqora-core-user-%d", userID)
}
...
const (
	defaultWaffoPancakeStoreName   = "solqora-core-store"
	defaultWaffoPancakeProductName = "solqora-core-charge-product"
)
...
//
// OnetimeProduct (not SubscriptionProduct) because solqora-core has no renewal-
// event handling; Pancake auto-renewing without solqora-core extending user
