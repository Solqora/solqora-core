...
func HasCSAMViolationMarker(err *types.solqoraError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.solqoraError) *types.solqoraError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.solqoraError) *types.solqoraError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.solqoraError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.solqoraError) bool {
