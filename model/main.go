...
func checkMySQLChineseSupport(db *gorm.DB) error {
	...
	if !isChineseCapable(schemaCharset, schemaCollation) {
		return fmt.Errorf("/schema(%s/%s) utf8mb4/utf8/gbk/big5/gb18030 / Schema default charset/collation is not Chinese-capable: schema(%s/%s). Please set to utf8mb4/utf8/gbk/big5/gb18030",
	...
	if len(badTables) > 0 {
		...
		return fmt.Errorf(
			"/ %d %v / Found tables not Chinese-capable. Please fix their collation/charset. Examples (showing up to %d): %v",
