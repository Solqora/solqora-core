...
type Token struct {
	...
	CrossGroupRetry    bool           `json:"cross_group_retry"` // auto
...
// sanitizeLikePattern  LIKE 
// 
//  1.  !  _ !  ESCAPE  MySQL/PostgreSQL/SQLite
//  2.  %  %
//  3.  2  %
//  4.  %  %  >= 2
//  5.  % 
...
func GetTokenByIds(id int, userId int) (*Token, error) {
	if id == 0 || userId == 0 {
		return nil, errors.New("id  userId ")
	}
...
// InvalidateUserTokensCache  Redis 
//  InvalidateUserCache /
// 
