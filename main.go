...
import (
	...
	"github.com/solqora/solqora-core/controller"
	...
	"github.com/solqora/solqora-core/oauth"
	perfmetrics "github.com/solqora/solqora-core/pkg/perf_metrics"
	"github.com/solqora/solqora-core/relay"
	"github.com/solqora/solqora-core/router"
	"github.com/solqora/solqora-core/service"
	_ "github.com/solqora/solqora-core/setting/performance_setting"
...
func main() {
	...
	common.SysLog("Solqora " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/solqora-core", err),
				"type":    "new_api_panic",
			},
		})
	}))
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami solqora-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics solqora-->\n")
	analyticsInject := []byte(analyticsInjectBuilder.String())
