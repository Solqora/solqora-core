...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (solqoraError *types.solqoraError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (solqoraError *types.solqoraError) {
	info.InitChannelMeta(c)
