...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (solqoraError *types.solqoraError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, solqoraErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if solqoraErr != nil {
			return solqoraErr
		}
