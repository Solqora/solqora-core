...
type WanImageInput struct {
	...
	Images         []string `json:"images"`                    // URL2HTTP/HTTPS URLBase64
	NegativePrompt string   `json:"negative_prompt,omitempty"` // 
}

type WanImageParameters struct {
	N         int     `json:"n,omitempty"`         // 1-44
	Watermark *bool   `json:"watermark,omitempty"` // false
	Seed      int     `json:"seed,omitempty"`      // [0, 2147483647]
	Strength  float64 `json:"strength,omitempty"`  //  0.0-1.00.5
}
