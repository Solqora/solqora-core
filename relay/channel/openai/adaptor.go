...
import (
	...
	"github.com/solqora/solqora-core/relay/channel/ai360"
	"github.com/solqora/solqora-core/relay/channel/lingyiwanwu"

	//"github.com/solqora/solqora-core/relay/channel/minimax"
	"github.com/solqora/solqora-core/relay/channel/openrouter"
	"github.com/solqora/solqora-core/relay/channel/xinference"
	relaycommon "github.com/solqora/solqora-core/relay/common"
	"github.com/solqora/solqora-core/relay/common_handler"
...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	case constant.ChannelTypeAzure:
		...
		// https://github.com/solqora/solqora-core/issues/67
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://www.solqora.ai")
		}
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "Solqora")
		}
	}
	return nil
}
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.solqoraError) {
	switch info.RelayMode {
