			...
			for _, mediaContent := range parseContent {
				...
				case dto.ContentTypeImageURL:
					...
					if media.IsRemoteImage() {
						//  #2083:  file
						//  file.Type = ...  nil pointer dereference
						//  panic500: "invalid memory address or nil pointer dereference"
						file = &DifyFile{
							Type:         media.MimeType,
...
func difyStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.solqoraError) {
...
func difyHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.solqoraError) {
