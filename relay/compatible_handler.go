...
func TextHelper(c *gin.Context, info *relaycommon.RelayInfo) (solqoraError *types.solqoraError) {
	...
	if info.RelayMode == relayconstant.RelayModeChatCompletions &&
		...
		usage, solqoraErr := chatCompletionsViaResponses(c, info, adaptor, request)
		if solqoraErr != nil {
			return solqoraErr
		}
	...
	usage, solqoraErr := adaptor.DoResponse(c, httpResp, info)
	if solqoraErr != nil {
		// reset status code 
		service.ResetStatusCode(solqoraErr, statusCodeMappingStr)
		return solqoraErr
