...
//  #4834: GET /v1/video/generations/:task_id && /v1/video/:task_id  model
//  token  modelLimitEnable 
// modelRequest.Model  "This token has no access to model"
//  OriginModelName 
...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.solqoraError {
	...
	key, index, solqoraError := channel.GetNextEnabledKey()
	if solqoraError != nil {
		return solqoraError
	}
